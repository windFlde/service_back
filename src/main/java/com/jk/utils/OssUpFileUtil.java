...
public class OssUpFileUtil {
     ...
     */
    private static String accessKeyId = "LTAI0TzZsFR2VLsN";
    private static String accessKeySecret = "pXb90YYBaTne7R089o1WkCnvEuIxKt";
    /**
     * Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
     */
    private static String bucketName = "erp-impw123";
    /**
     * OSS文件夹名称
     */
